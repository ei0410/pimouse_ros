...
class LightsensorTest(unittest.TestCase):
    ...
    def check_values(self,lf,ls,rs,rf):
        vs = self.values
        self.assertEqual(vs.left_forward, lf, "differenr value: left_forward")
        self.assertEqual(vs.left_side, ls, "differenr value: left_side")
        self.assertEqual(vs.right_side, rs, "differenr value: right_side")
        self.assertEqual(vs.right_forward, rf, "differenr value: right_forward")
        self.assertEqual(vs.sum_all, lf+ls+rs+rf, "differenr value: sum_all")
        self.assertEqual(vs.sum_forward, lf+rf, "differenr value: sum_forward")
